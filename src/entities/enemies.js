 ...
 *
 * Etappe 1 (neue Monster): Die ENEMIES-, COLORS- und LEVELS-Eintraege fuer die
 * fuenf neuen Monster werden hier registriert, indem die importierten Objekte
 * aus config.js mutiert werden. Das funktioniert, weil ES-Module Live-Bindings
 ...
 *
 * Etappe 2 (neue Level 11-15): Die LEVELS-Eintraege werden hier per push()
 * hinzugefuegt — gleicher Mechanismus, gleicher Grund.
 */
...
// --- Etappe 1: Gegner-Configs registrieren (mutiert das ENEMIES-Objekt) ---
...
LEVELS.push(
  { name: 'Burgfried', url: './assets/levels/level11.json', built: true,
    description: 'Zwoelf Ritter patrouillieren den Burghof.' },
  { name: 'Thronsaal', url: './assets/levels/level12.json', built: true,
    description: 'Magier und Ritter verteidigen den Thronsaal.' },
  { name: 'Kapelle', url: './assets/levels/level13.json', built: true,
    description: 'Paladine, Ritter und Magier halten die Kapelle.' },
  { name: 'Verlies', url: './assets/levels/level14.json', built: true,
    description: 'Neun Werwoelfe lauern im dunklen Verlies.' },
