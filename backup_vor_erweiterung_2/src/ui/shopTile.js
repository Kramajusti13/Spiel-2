...
export class ShopTile {
  ...
  /**
   * Zeilen anlegen. Die Warenliste ist fest (Schwert, Bogen, Schild, Trank,
   * Reset), nur ihr Inhalt wechselt — also einmal bauen und danach nur noch
   * beschriften, statt bei jedem Kauf neu.
   */
  build() {
