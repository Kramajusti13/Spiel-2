...
import { PLAYER, SWORD, SHIELD, BOW, ROLL, SKILLS, XP, COMBAT, CONSUMABLES, COLORS, SPRITES, TILE } from '../config.js';
...
export class Player {
  ...
  resolveSwingHits(game) {
    ...
    for (const enemy of game.enemies) {
      ...
      enemy.takeDamage(damage, this.aim, SWORD.knockback, game, crit, 'sword');
    }
  }
