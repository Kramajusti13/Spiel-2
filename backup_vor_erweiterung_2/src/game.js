...
import { VIEW, COLORS, DEATH, DEBUG, DIFFICULTY_ORDER, LEVEL, LEVELS, LOOT, PLAYER, ROLL, SAVE, UI, XP } from './config.js';
...
import { activeQuests, claimQuest, questProgress } from './quests.js';
...
export class Game {
  ...
  finishLevel() {
    ...
    // Quest 11: jedes der fuenf Level einmal auf Alptraum ohne einen Tod.
