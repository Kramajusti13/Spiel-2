...
export const ENEMIES = {
  ...
  goblin: {
    ...
    knockbackResist: 0.1, gold: { min: 8, max: 15 },
  },
  ...
  archer: {
    ...
    hitbox: { w: 20, h: 24 }, sprite: { w: 22, h: 26, offsetY: -2 },
    knockbackResist: 0.1, gold: { min: 12, max: 20 },
  },
  ...
  armoredOrc: {
    ...
    knockbackResist: 0.6, gold: { min: 30, max: 50 },
  },
  ...
  orcChieftain: {
    ...
    knockbackResist: 0.9, gold: { min: 200, max: 200 },
    /** Zusaetzlicher Skillpunkt fuer den Boss (Abschnitt 4). */
    skillPoints: 1,
    isBoss: true,
  },
};
 ...
 */
export const LEVELS = [
  { name: 'Waldlichtung', url: './assets/levels/level1.json', built: true },
  { name: 'Hoehleneingang', url: './assets/levels/level2.json', built: true },
  { name: 'Ruinen', url: './assets/levels/level3.json', built: true },
  { name: 'Orklager', url: './assets/levels/level4.json', built: true },
  { name: 'Bosskammer', url: './assets/levels/level5.json', built: true },
];
